...
print_info "Check the progress at: https://github.com/chriswessels/llama-swap-swiftbar-plugin/actions"
...
if command -v open > /dev/null && [[ "$OSTYPE" == "darwin"* ]]; then
    ...
    open "https://github.com/chriswessels/llama-swap-swiftbar-plugin/releases"
fi